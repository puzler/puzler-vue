...
// An author's rich HTML body (puzzle description, collection page). `html`
// must already be sanitized by the caller (sanitizeHtml/DOMPurify). Carries
// only the prose typography; hosts provide their own card/panel chrome.
