...
export type RatePuzzleInput = {
  ...
  difficultyVote?: InputMaybe<RatingDifficultyEnum>;
...
export type Rating = {
  ...
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Difficulty assessment: easy, medium, hard, or expert */
  difficultyVote?: Maybe<RatingDifficultyEnum>;
  /** Unique rating ID */
  id: Scalars['ID']['output'];
  /** Star rating from 1 to 5 */
...
/** A solver's difficulty vote: easy, medium, hard, or expert */
export const RatingDifficultyEnum = {
  Easy: 'EASY',
  Expert: 'EXPERT',
  Hard: 'HARD',
  Medium: 'MEDIUM'
...
export type RatingDifficultyEnum = typeof RatingDifficultyEnum[keyof typeof RatingDifficultyEnum];
