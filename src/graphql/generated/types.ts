...
export type Mutation = CollectionMutations & ConstraintMutations & CosmeticMutations & PlayMutations & PuzzleMutations & SocialMutations & UserMutations & {
  __typename?: 'Mutation';
  /** Add a puzzle to a collection */
  addPuzzleToCollection?: Maybe<AddPuzzleToCollectionPayload>;
...
export type Query = CollectionQueries & PuzzleQueries & TagQueries & UserQueries & {
  __typename?: 'Query';
  /** Find a collection by ID, if the current user is allowed to see it */
  collection?: Maybe<Collection>;
  /** Find a collection by its share token (for unlisted/series links) */
