...
export type VersionFullFragment = { definition: unknown, solution: unknown, solutionHash: string | null, id: string, versionNumber: number, displayName: string, label: string | null, isPublished: boolean, constraintTypes: Array<string>, createdAt: string };
...
export type MyPuzzlesQuery = { myPuzzles: Array<{ id: string, title: string, status: string, visibility: string, shareToken: string | null, publishedVersion: { id: string, displayName: string } | null }> };
...
export type PuzzleVersionQuery = { puzzleVersion: { definition: unknown, solution: unknown, solutionHash: string | null, id: string, versionNumber: number, displayName: string, label: string | null, isPublished: boolean, constraintTypes: Array<string>, createdAt: string } | null };
