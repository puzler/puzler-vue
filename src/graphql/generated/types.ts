...
export type ChangePasswordMutation = { changePassword: { token: string | null, errors: Array<string>, user: { id: string, email: string | null, username: string, displayName: string, avatarUrl: string | null, bio: string | null, role: Types.UserRoleEnum, passwordSet: boolean | null, playerSettings: unknown, colorPalette: unknown, activeThemeId: string | null, enableCustomStyles: boolean | null, hidePatronTeasers: boolean | null, profileVisibility: { solveHistory: Types.SolveHistoryVisibilityEnum, stats: boolean, favorites: boolean, subscriptions: boolean, activity: boolean }, puzzlePreferences: { includeSolutionInSudokupadExport: boolean, commentsRequireSolveDefault: boolean } | null, userThemes: Array<{ id: string, name: string, basePresetId: string, schemaVersion: number, appearance: unknown, constraints: unknown, position: number }> | null, oauthConnections: Array<{ provider: string, createdAt: string }> | null, patreon: { capabilities: { memberships: boolean, creator: boolean } | null, campaign: { id: string, title: string | null, url: string | null, currency: string | null, status: Types.PatreonCampaignStatusEnum, teasersEnabled: boolean, campaignSyncedAt: string | null, tiers: Array<{ id: string, patreonId: string, title: string, amountCents: number, published: boolean, discarded: boolean }> } | null, memberships: Array<{ id: string, patronStatus: Types.PatronStatusEnum, entitledAmountCents: number, syncedAt: string, campaign: { title: string | null, url: string | null, currency: string | null, creatorUsername: string | null } }> } | null } | null } | null };
...
export type RefreshPatreonMembershipsMutationVariables = Exact<{ [key: string]: never; }>;


export type RefreshPatreonMembershipsMutation = { refreshPatreonMemberships: { errors: Array<string>, user: { id: string, email: string | null, username: string, displayName: string, avatarUrl: string | null, bio: string | null, role: Types.UserRoleEnum, passwordSet: boolean | null, playerSettings: unknown, colorPalette: unknown, activeThemeId: string | null, enableCustomStyles: boolean | null, hidePatronTeasers: boolean | null, profileVisibility: { solveHistory: Types.SolveHistoryVisibilityEnum, stats: boolean, favorites: boolean, subscriptions: boolean, activity: boolean }, puzzlePreferences: { includeSolutionInSudokupadExport: boolean, commentsRequireSolveDefault: boolean } | null, userThemes: Array<{ id: string, name: string, basePresetId: string, schemaVersion: number, appearance: unknown, constraints: unknown, position: number }> | null, oauthConnections: Array<{ provider: string, createdAt: string }> | null, patreon: { capabilities: { memberships: boolean, creator: boolean } | null, campaign: { id: string, title: string | null, url: string | null, currency: string | null, status: Types.PatreonCampaignStatusEnum, teasersEnabled: boolean, campaignSyncedAt: string | null, tiers: Array<{ id: string, patreonId: string, title: string, amountCents: number, published: boolean, discarded: boolean }> } | null, memberships: Array<{ id: string, patronStatus: Types.PatronStatusEnum, entitledAmountCents: number, syncedAt: string, campaign: { title: string | null, url: string | null, currency: string | null, creatorUsername: string | null } }> } | null } | null } | null };
...
export type SyncPatreonCampaignMutationVariables = Exact<{ [key: string]: never; }>;


export type SyncPatreonCampaignMutation = { syncPatreonCampaign: { errors: Array<string>, campaign: { id: string } | null } | null };

export type UpdatePatreonCampaignSettingsMutationVariables = Exact<{
  teasersEnabled: boolean;
}>;


export type UpdatePatreonCampaignSettingsMutation = { updatePatreonCampaignSettings: { errors: Array<string>, campaign: { id: string, teasersEnabled: boolean } | null } | null };
...
export type AddStoryPageToCollectionMutationVariables = Exact<{
  collectionId: string | number;
  title?: string | null | undefined;
}>;


export type AddStoryPageToCollectionMutation = { addStoryPageToCollection: { errors: Array<string>, storyPage: { id: string, title: string | null, bodyHtml: string | null } | null, collection: { id: string } | null } | null };
...
export type RemoveCollectionEntryMutationVariables = Exact<{
  collectionId: string | number;
...
export type ReorderCollectionEntriesMutationVariables = Exact<{
  collectionId: string | number;
...
export type ScheduleCollectionReleaseMutationVariables = Exact<{
  id: string | number;
  releasedAt?: string | null | undefined;
}>;


export type ScheduleCollectionReleaseMutation = { scheduleCollectionRelease: { errors: Array<string>, collection: { id: string, releasedAt: string | null } | null } | null };

export type SetCollectionPatronGateMutationVariables = Exact<{
  id: string | number;
  gate?: Types.PatronGateInput | null | undefined;
}>;


export type SetCollectionPatronGateMutation = { setCollectionPatronGate: { errors: Array<string>, collection: { id: string, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type SubmitCollectionCodewordMutation = { submitCollectionCodeword: { matched: boolean, errors: Array<string> } | null };
...
export type UpdateCollectionEntryMutationVariables = Exact<{
  collectionId: string | number;
  entryId: string | number;
  gates: Types.CollectionEntryGatesInput;
}>;


export type UpdateCollectionEntryMutation = { updateCollectionEntry: { errors: Array<string>, collection: { id: string } | null } | null };
...
export type UpdateStoryPageMutation = { updateStoryPage: { errors: Array<string>, storyPage: { id: string, title: string | null, bodyHtml: string | null } | null } | null };
...
export type UploadStoryPageImageMutationVariables = Exact<{
  storyPageId: string | number;
  file: File;
}>;


export type UploadStoryPageImageMutation = { uploadStoryPageImage: { url: string | null, errors: Array<string> } | null };
...
export type CollectionDetailQuery = { collection: { id: string, title: string, kind: Types.CollectionKindEnum, description: string | null, pageDescriptionHtml: string | null, coverImageUrl: string | null, accentColor: Types.CollectionAccentColorEnum, bgTreatment: Types.CollectionBgTreatmentEnum, titleFont: Types.CollectionTitleFontEnum, visibility: Types.CollectionVisibilityEnum, mode: Types.CollectionModeEnum, timed: boolean, shareToken: string | null, releasedAt: string | null, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null, competitionConfig: { timeLimitSeconds: number | null, submissionPolicy: Types.CompetitionSubmissionPolicyEnum, penaltyPoints: number, bonusPointsPerMinute: number, clampScoreAtZero: boolean, showEntryPoints: boolean, enforcedSettings: unknown, locked: boolean } | null, entries: Array<{ id: string, entryType: string, position: number, gated: boolean, hidden: boolean, finale: boolean, releasedAt: string | null, points: number | null, puzzle: { id: string, title: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, constraintTypes: Array<string> } | null, storyPage: { id: string, title: string | null, bodyHtml: string | null } | null }> } | null };
...
export type CollectionsQuery = { collections: { nodes: Array<{ id: string, title: string, coverThumbUrl: string | null, visibility: Types.CollectionVisibilityEnum, mode: Types.CollectionModeEnum, puzzleCount: number, avgRating: number | null, solveCount: number, author: { id: string, username: string, displayName: string, setterTier: Types.SetterTierEnum }, patronAccess: { hasAccess: boolean } | null }>, pageInfo: { page: number, perPage: number, totalCount: number, totalPages: number, hasNextPage: boolean, hasPreviousPage: boolean } } };
...
export type ConfigurePuzzlePageMutation = { configurePuzzlePage: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type GrantPuzzleAccessMutation = { grantPuzzleAccess: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type PublishPuzzleVersionMutation = { publishPuzzleVersion: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type RevokePuzzleAccessMutation = { revokePuzzleAccess: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type SchedulePuzzleReleaseMutationVariables = Exact<{
  id: string | number;
  releasedAt?: string | null | undefined;
}>;


export type SchedulePuzzleReleaseMutation = { schedulePuzzleRelease: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };

export type SetPuzzlePatronGateMutationVariables = Exact<{
  id: string | number;
  gate?: Types.PatronGateInput | null | undefined;
}>;


export type SetPuzzlePatronGateMutation = { setPuzzlePatronGate: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type SetPuzzleVisibilityMutation = { setPuzzleVisibility: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type UnpublishPuzzleMutation = { unpublishPuzzle: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type UpdatePageDescriptionMutation = { updatePageDescription: { errors: Array<string>, puzzle: { id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null } | null };
...
export type PuzzleDescriptionQuery = { puzzle: { id: string, title: string, authorName: string | null, description: string | null, pageDescriptionHtml: string | null, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, publishedAt: string | null, effectiveDifficulty: number | null, avgRating: number | null, solveCount: number, favoriteCount: number, constraintTypes: Array<string>, sudokupadUrl: string | null, sudokupadIncludesSolution: boolean, commentsRequireSolveEffective: boolean, viewerHasSolved: boolean, hasSolutionCode: boolean, isFavorited: boolean, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, grid: { rows: number, cols: number }, author: { id: string, username: string, displayName: string, avatarUrl: string | null }, publishedVersion: { id: string, definition: unknown, solutionHash: string | null } | null, myRating: { stars: number | null, difficultyVote: number | null } | null, comments: Array<{ id: string, body: string, createdAt: string, commenterSolved: boolean, isAuthor: boolean, isSpoiler: boolean, spoilersRedacted: boolean, spoilerMarkedBySetter: boolean, canDelete: boolean, canMarkSpoiler: boolean, replies: Array<{ id: string, body: string, createdAt: string, commenterSolved: boolean, isAuthor: boolean, isSpoiler: boolean, spoilersRedacted: boolean, spoilerMarkedBySetter: boolean, canDelete: boolean, canMarkSpoiler: boolean, segments: Array<{ spoiler: boolean, redacted: boolean, text: string | null }>, user: { id: string, username: string, displayName: string, avatarUrl: string | null } }>, segments: Array<{ spoiler: boolean, redacted: boolean, text: string | null }>, user: { id: string, username: string, displayName: string, avatarUrl: string | null } }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { title: string, amountCents: number, id: string } | null, tiers: Array<{ title: string, amountCents: number, id: string }> } | null, patronAccess: { hasAccess: boolean, lockedReason: Types.PatronLockReasonEnum | null, requiredTierTitle: string | null, requiredAmountCents: number | null, campaignTitle: string | null, campaignUrl: string | null } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }> } | null };
...
export type PuzzleForEditQuery = { puzzle: { title: string, description: string | null, authorDifficulty: number | null, id: string, status: Types.PuzzleStatusEnum, visibility: Types.PuzzleVisibilityEnum, shareToken: string | null, pageDescriptionHtml: string | null, commentsRequireSolveOverride: boolean | null, releasedAt: string | null, versions: Array<{ id: string, versionNumber: number, displayName: string, label: string | null, isPublished: boolean, constraintTypes: Array<string>, createdAt: string }>, publishedVersion: { id: string } | null, grantedUsers: Array<{ id: string, username: string, displayName: string }>, patronGate: { mode: Types.PatronGateModeEnum, minAmountCents: number | null, patronsSinceRelease: boolean, minTier: { id: string } | null, tiers: Array<{ id: string }> } | null } | null };
...
export type PuzzlesQuery = { puzzles: { nodes: Array<{ id: string, title: string, constraintTypes: Array<string>, avgRating: number | null, effectiveDifficulty: number | null, solveCount: number, featured: boolean, authorName: string | null, grid: { rows: number, cols: number }, author: { id: string, username: string, displayName: string, setterTier: Types.SetterTierEnum }, patronAccess: { hasAccess: boolean } | null }>, pageInfo: { page: number, perPage: number, totalCount: number, totalPages: number, hasNextPage: boolean, hasPreviousPage: boolean } } };
...
export type PatronFeedQueryVariables = Exact<{ [key: string]: never; }>;


export type PatronFeedQuery = { patronReleases: Array<
    | { id: string, title: string, puzzleCount: number, effectiveReleaseAt: string | null, author: { username: string, displayName: string }, patronAccess: { hasAccess: boolean } | null }
    | { id: string, title: string, effectiveReleaseAt: string | null, author: { username: string, displayName: string }, patronAccess: { hasAccess: boolean } | null }
  > };
...
export type ProfileSolvedPuzzlesQuery = { user: { id: string, solvedPuzzles: { nodes: Array<{ puzzle: { id: string, title: string, constraintTypes: Array<string>, avgRating: number | null, effectiveDifficulty: number | null, solveCount: number, featured: boolean, authorName: string | null, grid: { rows: number, cols: number }, author: { id: string, username: string, displayName: string, setterTier: Types.SetterTierEnum }, patronAccess: { hasAccess: boolean } | null }, ownerRating: { stars: number | null, difficultyVote: number | null } | null, ownerReview: { id: string, body: string, createdAt: string } | null }>, pageInfo: { page: number, perPage: number, totalCount: number, totalPages: number, hasNextPage: boolean, hasPreviousPage: boolean } } } | null };
