...
export type CosmeticElementsInput = {
  ...
  /** Cosmetic Rectangles */
  rectangles?: InputMaybe<Array<CosmeticShapeInput>>;
  /** Cosmetic Text */
...
/** Input for a cosmetic shape */
export type CosmeticShapeInput = {
...
export type PuzlerMutations = AuthMutations & PuzzleMutations & {
  ...
  savePuzzle?: Maybe<SavePuzzlePayload>;
  /** Used to sign in with email and password */
  signIn?: Maybe<SignInPayload>;
  /** Used to sign in with a OAuth code */
  signInWithOAuth?: Maybe<SignInWithOAuthPayload>;
...
/** The base Mutation Object */
export type PuzlerMutationsSavePuzzleArgs = {
...
export type PuzzleInput = {
  ...
  /** The Puzzle Solution */
  solution?: InputMaybe<Array<Array<InputMaybe<Scalars['Int']['input']>>>>;
  /** Puzzle Title */
...
/** Base Mutation object for Puzzles */
export type PuzzleMutationsSavePuzzleArgs = {
  input: SavePuzzleInput;
};
...
/** Autogenerated input type of SavePuzzle */
...
/** Autogenerated return type of SavePuzzle. */
export type SavePuzzlePayload = {
  __typename?: 'SavePuzzlePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** Error messages passed along with mutation response */
  errors?: Maybe<Array<Scalars['String']['output']>>;
  /** The new saved puzzle */
  puzzle?: Maybe<Puzzle>;
  /** Flag marking if mutation was successful */
  success: Scalars['Boolean']['output'];
};
