...
<template>
  ...
  <div v-else class="flex flex-col bg-white overflow-y-auto h-full">
    ...
    <!-- ── Region ───────────────────────────────────────────────────────── -->
    <div v-else-if="editor.activeTool === 'region'" class="flex flex-col h-full p-3 gap-3">
      <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-400">Region</p>
      <!-- 3×3 numpad for 1–9 -->
